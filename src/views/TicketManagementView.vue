            ...
            <table class="tickets-table">
                ...
                <tbody>
                    <tr v-for="ticket in tickets" :key="ticket.id" class="ticket-row">
                        ...
                        <td>
                            <Chip :color="getPriorityInfo(ticket.priority).color"
                                :text="getPriorityInfo(ticket.priority).label" />
                        </td>
                        <td>
                            <Chip :color="getStatusInfo(ticket.status).color"
                                :text="getStatusInfo(ticket.status).label" />
                        </td>
                        ...
                        <td>
                            <div class="actions">
                                ...
                                <button v-if="canEditTicket(ticket)" @click="openEditModal(ticket)" class="edit-btn"
                                    title="Editar">
                                    <i class="icon-edit"></i>
                                </button>
                                <button v-if="canAssignTicket(ticket)" @click="openAssignModal(ticket)"
                                    class="assign-btn" title="Asignar">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <select id="ticketPriority" v-model="formData.priority" required>
                                ...
                                <option v-for="priority in ticketPriorities" :key="priority.value"
                    ...
                    <div class="form-row" v-if="editingTicket">
                        <div class="form-group">
                            ...
                            <select id="ticketStatus" v-model="formData.status">
                                <option v-for="status in getAvailableStatuses()" :key="status.value"
                                    :value="status.value">
                                    {{ status.label }}
                                </option>
                            </select>
            ...
            <div class="detail-modal" @click.stop>
                ...
                <div class="detail-content" v-if="selectedTicket && !detailLoading">
                    ...
                    <div class="detail-actions">
                        ...
                        <!-- Admin Assignment -->
                        <button v-if="userRole === 'admin'" @click="openAssignModal(selectedTicket)"
                        ...
                        <div class="status-actions">
                            ...
                            <select v-if="userRole === 'admin'" v-model="selectedTicket.status"
                                @change="updateTicketStatus(selectedTicket, selectedTicket.status)"
                                class="status-select">
                                <option v-for="status in ticketStatuses" :key="status.value" :value="status.value">
                                    {{ status.label }}
                                </option>
